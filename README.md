...
Ferramenta simples para converter planilhas Excel de orçamento (com colunas/células “REFERÊNCIA” e “QTDE.”) em arquivos CSV prontos para importação, seguindo o padrão do arquivo de amostra `planilha-base-stihl.csv`.

## Como usar

1. Baixe o executável `orcamento-stihl.exe` na seção [Releases](https://github.com/atiliofranca/conversor-orcamento-stihl-makino/releases/tag/v1.1.0) do GitHub.
